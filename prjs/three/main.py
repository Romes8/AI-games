...
def init_params(key, input_shape, n_classes):
    ...
    return {
        ...
        'dense1': random.normal(k3, (flattened_size, 512)),
        'dense2': random.normal(k4, (512, n_classes)),
    }
...
visualize_results(params, X, y, unique_labels)
# %%
